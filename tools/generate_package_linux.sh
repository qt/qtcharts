...
CHARTS_FINAL_TAR=$CHARTS_CURRENT_DIR/../qtcharts-enterprise-src-$CHARTS_VERSION.tar
CHARTS_FINAL_ZIP=$CHARTS_CURRENT_DIR/../qtcharts-enterprise-src-$CHARTS_VERSION.zip
CHARTS_FINAL_7Z=$CHARTS_CURRENT_DIR/../qtcharts-enterprise-src-$CHARTS_VERSION.7z
...
CHARTS_EXAMPLES_FINAL_TAR=$CHARTS_CURRENT_DIR/../qtcharts-enterprise-examples-$CHARTS_VERSION.tar
CHARTS_EXAMPLES_FINAL_7Z=$CHARTS_CURRENT_DIR/../qtcharts-enterprise-examples-$CHARTS_VERSION.7z
...
CHARTS_DOCS_FINAL_TAR=$CHARTS_CURRENT_DIR/../qtcharts-enterprise-doc-$CHARTS_VERSION.tar
CHARTS_DOCS_FINAL_ZIP=$CHARTS_CURRENT_DIR/../qtcharts-enterprise-doc-$CHARTS_VERSION.zip
CHARTS_DOCS_FINAL_7Z=$CHARTS_CURRENT_DIR/../qtcharts-enterprise-doc-$CHARTS_VERSION.7z
...
7z a $CHARTS_DOCS_FINAL_7Z * > /dev/null
cd $CHARTS_CURRENT_DIR
